...
public class YandexFileSearch {
    ...
    private Map<String, String> queryToFileMap = new HashMap<>();
    private static final String pathToMapping = "c:\\Users\\Alexey\\Documents\\Programming\\University\\Researches\\DataFusion\\searchQueriesTitleMapping.txt";
    private static final String pathToResults = "c:\\Users\\Alexey\\Documents\\Programming\\University\\Researches\\yandexQueries\\";
    ...
    public String[] getQueryResults(String query) {
        ...
        try {
            ...
            Document doc = builder.parse(String.format("%s%s", pathToResults, queryToFileMap.get(query)));
